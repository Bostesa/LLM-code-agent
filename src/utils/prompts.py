...
ERROR_ANALYSIS_PROMPT = """You are a Dafny verification expert. Analyze these errors and provide SPECIFIC, ACTIONABLE fixes.
...
DAFNY_GENERATOR_PROMPT = """You are a Dafny expert. Generate verified Dafny code for this specification.
